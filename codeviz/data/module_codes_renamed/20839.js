...
class ResponseError extends Error {
  constructor(e, t, r) {
    super(t);
    this.code = M_TypeChecker_maybe.number(e) ? e : i.UnknownErrorCode;
    this.data = r;
...
exports.isRequestMessage = function (e) {
  ...
  return (
    t &&
    M_TypeChecker_maybe.string(t.method) &&
    (M_TypeChecker_maybe.string(t.id) || M_TypeChecker_maybe.number(t.id))
  );
};
exports.isNotificationMessage = function (e) {
  const t = e;
  return t && M_TypeChecker_maybe.string(t.method) && undefined === e.id;
};
