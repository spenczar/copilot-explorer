...
const o = {
  nextTick: require("HookedNextTickModule"),
  promise: require("Hooks-Promise-Wrapper"),
  timers: require("TimerCallbackManager"),
};
const s = new Set();
function a() {
  this.enabled = false;
...
function u() {
  this._state = new a();
  this._hooks = new c();
  this.version = require("language-marker-constants").i8;
