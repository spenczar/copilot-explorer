...
const M_MessageBufferManager_maybe = require("MessageBufferManager");
class a extends M_MessageBufferManager_maybe.AbstractMessageBuffer {
  constructor(e = "utf-8") {
    super(e);
  }
  emptyBuffer() {
  ...
  toString(e, t) {
    return e instanceof Buffer
      ? e.toString(t)
      : new M_util.TextDecoder(t).decode(e);
  }
  asNative(e, t) {
    return undefined === t
      ? e instanceof Buffer
...
class c {
  ...
  onClose(e) {
    ...
    return M_DisposableManager_maybe.Disposable.create(() =>
      this.stream.off("close", e)
    );
  }
  onError(e) {
    this.stream.on("error", e);
    return M_DisposableManager_maybe.Disposable.create(() =>
      this.stream.off("error", e)
    );
  }
  onEnd(e) {
    this.stream.on("end", e);
    return M_DisposableManager_maybe.Disposable.create(() =>
      this.stream.off("end", e)
    );
  }
  onData(e) {
    this.stream.on("data", e);
    return M_DisposableManager_maybe.Disposable.create(() =>
      this.stream.off("data", e)
    );
  }
}
class l {
      ...
      decode: (e, t) => {
        try {
          return e instanceof Buffer
            ...
            : Promise.resolve(
                JSON.parse(new M_util.TextDecoder(t.charset).decode(e))
              );
        } catch (e) {
          return Promise.reject(e);
        }
...
!(function (e) {
  e.install = function () {
    M_RuntimeAbstractionLayerManager_maybe.default.install(u);
  };
})(d || (d = {}));
exports.default = d;
