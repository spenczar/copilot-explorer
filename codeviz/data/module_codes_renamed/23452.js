...
var o = (function () {
  function e(t, r) {
    ...
    if (t && "string" == typeof t) {
      if (t.split(",").length > 1)
        (this.traceId = M_CookieParserUtils_maybe.w3cTraceId()),
          (this.spanId = M_CookieParserUtils_maybe.w3cTraceId().substr(0, 16));
      else {
        var o = t.trim().split("-"),
          s = o.length;
        s >= 4
          ? ((this.version = o[0]),
            ...
            (this.traceFlag = o[3]))
          : ((this.traceId = M_CookieParserUtils_maybe.w3cTraceId()),
            (this.spanId = M_CookieParserUtils_maybe.w3cTraceId().substr(
              0,
              16
            ))),
      ...
      var a = M_correlation_id_manager_maybe.getRootId(r);
      e.isValidTraceId(a) ||
        ((this.legacyRootId = a), (a = M_CookieParserUtils_maybe.w3cTraceId())),
        -1 !== r.indexOf("|") &&
          (r = r.substring(
