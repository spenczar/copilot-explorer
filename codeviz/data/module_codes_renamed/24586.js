...
const a = new M_LoggingUtils_maybe.Logger(
...
class SSEProcessor {
  constructor(e, t, r, n, i, o) {
    ...
    this.requestId = M_language_logprob_utils_maybe.getRequestId(this.response);
      ...
      for (const r of i) {
        ...
        if (undefined !== i.choices) {
          if (0 == this.requestId.created) {
            this.requestId = M_language_logprob_utils_maybe.getRequestId(
              this.response,
              i
            );
            if (0 == this.requestId.created) {
...
exports.prepareSolutionForReturn = function (e, t, r) {
  ...
  return M_language_logprob_utils_maybe.convertToAPIChoice(
    e,
    n,
    o,
    t.index,
