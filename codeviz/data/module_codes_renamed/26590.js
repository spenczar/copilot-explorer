...
var o = (function () {
    ...
    if (e.completedLookups.hasOwnProperty(o)) r(e.completedLookups[o]);
      ...
      var s = function () {
        if (e.pendingLookups[o]) {
          ...
          M_LoggingUtils_maybe.info(e.TAG, r);
          var a = M_CookieParserUtils_maybe.makeRequest(t, o, r, function (r) {
            if (200 === r.statusCode) {
              var n = "";
              r.setEncoding("utf-8");
              ...
              r.on("end", function () {
                M_LoggingUtils_maybe.info(e.TAG, n);
          ...
          if (a) {
            a.on("error", function (t) {
              M_LoggingUtils_maybe.warn(e.TAG, t);
            });
            a.end();
          }
        }
  ...
  e.generateRootId = function () {
    return "|" + M_CookieParserUtils_maybe.w3cTraceId() + ".";
  };
  e.appendSuffix = function (t, r, i) {
    ...
    for (r = M_CookieParserUtils_maybe.randomu32().toString(16); r.length < 8; )
      r = "0" + r;
  ...
  e.currentRootId = M_CookieParserUtils_maybe.randomu32();
  return e;
})();
module.exports = o;
