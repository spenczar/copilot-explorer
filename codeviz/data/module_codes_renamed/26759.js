...
(module.exports = M_OptionsManager_maybe.prng =
  M_OptionsManager_maybe.prng || {}).create = function (e) {
  for (
    t = {
      plugin: e,
      key: null,
  ...
  function l(e) {
    var t = null;
    var r = M_OptionsManager_maybe.util.globalScope;
  ...
  t.generate = function (e, r) {
    ...
    var l = M_OptionsManager_maybe.util.createBuffer();
    t.key = null;
    (function u(d) {
      if (d) return r(d);
      ...
      if (null === t.key)
        return M_OptionsManager_maybe.util.nextTick(function () {
          !(function (e) {
      ...
      M_OptionsManager_maybe.util.setImmediate(u);
    })();
  };
  t.generateSync = function (e) {
    ...
    t.key = null;
    for (var c = M_OptionsManager_maybe.util.createBuffer(); c.length() < e; ) {
      if (t.generated > 1048575) {
        t.key = null;
      }
      if (null === t.key) {
  ...
  if (M_crypto) {
    t.seedFile = function (e, t) {
      M_crypto.randomBytes(e, function (e, r) {
        if (e) return t(e);
        t(null, r.toString());
      });
    };
    t.seedFileSync = function (e) {
      return M_crypto.randomBytes(e).toString();
    };
  } else {
    t.seedFile = function (e, t) {
      try {
