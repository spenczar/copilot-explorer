...
class i {
  ...
  remove(e, t = null) {
    ...
    for (
      ...
      M_RuntimeAbstractionLayerManager_maybe < i;
      M_RuntimeAbstractionLayerManager_maybe++
    )
      if (this._callbacks[M_RuntimeAbstractionLayerManager_maybe] === e) {
        if (this._contexts[M_RuntimeAbstractionLayerManager_maybe] === t) {
          this._callbacks.splice(M_RuntimeAbstractionLayerManager_maybe, 1);
          return void this._contexts.splice(
            M_RuntimeAbstractionLayerManager_maybe,
            1
          );
        }
  ...
  invoke(...e) {
    ...
    for (
      ...
      try {
        ...
        M_RuntimeAbstractionLayerManager_maybe.default().console.error(e);
      }
    return t;
  }
  isEmpty() {
