...
M_OptionsManager_maybe.cipher = M_OptionsManager_maybe.cipher || {};
var i =
  (module.exports =
  M_OptionsManager_maybe.cipher.modes =
    M_OptionsManager_maybe.cipher.modes || {});
function o(e, t) {
  if ("string" == typeof e) {
    e = M_OptionsManager_maybe.util.createBuffer(e);
  }
  if (M_OptionsManager_maybe.util.isArray(e) && e.length > 4) {
    var r = e;
    e = M_OptionsManager_maybe.util.createBuffer();
  ...
  if (!M_OptionsManager_maybe.util.isArray(e)) {
    var o = [];
    var s = t / 4;
...
i.cfb = function (e) {
  ...
  this._partialOutput = M_OptionsManager_maybe.util.createBuffer();
...
i.gcm.prototype.start = function (e) {
  if (!("iv" in e)) throw new Error("Invalid IV parameter.");
  var t;
  var r = M_OptionsManager_maybe.util.createBuffer(e.iv);
  this._cipherLength = 0;
  t =
    "additionalData" in e
      ? M_OptionsManager_maybe.util.createBuffer(e.additionalData)
      : M_OptionsManager_maybe.util.createBuffer();
  this._tagLength = "tagLength" in e ? e.tagLength : 128;
  this._tag = null;
  if (
    e.decrypt &&
    ((this._tag = M_OptionsManager_maybe.util.createBuffer(e.tag).getBytes()),
  ...
  s(this._inBlock);
  this._partialBytes = 0;
  t = M_OptionsManager_maybe.util.createBuffer(t);
...
i.gcm.prototype.afterFinish = function (e, t) {
  ...
  this.tag = M_OptionsManager_maybe.util.createBuffer();
