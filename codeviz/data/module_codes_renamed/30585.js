...
var i =
  (module.exports =
  M_OptionsManager_maybe.pkcs1 =
    M_OptionsManager_maybe.pkcs1 || {});
function o(e, t, r) {
  if (r) {
    r = M_OptionsManager_maybe.md.sha1.create();
  }
  for (
...
i.encode_rsa_oaep = function (e, t, r) {
  ...
  if (a) {
    ...
    a = M_OptionsManager_maybe.md.sha1.create();
  }
  if (c) {
    c = a;
  }
  ...
  } else s = M_OptionsManager_maybe.random.getBytes(a.digestLength);
  var y = o(s, l - a.digestLength - 1, c);
  var v = M_OptionsManager_maybe.util.xorBytes(g, y, g.length);
  var _ = o(v, a.digestLength, c);
  var b = M_OptionsManager_maybe.util.xorBytes(s, _, s.length);
  return "\0" + b + v;
};
i.decode_rsa_oaep = function (e, t, r) {
  ...
  for (
    l = s.digest().getBytes(),
      ...
      f = M_OptionsManager_maybe.util.xorBytes(d, h, d.length),
      g = o(f, c - s.digestLength - 1, a),
      m = M_OptionsManager_maybe.util.xorBytes(p, g, p.length),
