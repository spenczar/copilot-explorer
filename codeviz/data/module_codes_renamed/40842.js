...
function deparseTree(e) {
  return M_TreeTraversalUtils_maybe.foldTree(
    e,
    "",
    function (e, t) {
      let r = "";
      if (M_TreeNodeUtils_maybe.isLine(e)) {
        ...
        if (M_TreeNodeUtils_maybe.isBlank(e)) {
          r = "\n";
        }
      }
      return t + r;
...
exports.deparseAndCutTree = function (e, t) {
  ...
  (function e(t) {
    if (undefined !== t.label && r.has(t.label)) {
      ...
      if (M_TreeNodeUtils_maybe.isLine(t)) {
        a += deparseLine(t);
      }
      t.subs.forEach(e);
    }
...
exports.describeTree = function e(t, r = 0) {
  ...
  o = "" === o ? "[]" : `[\n${o}\n      ${i}]`;
  const s =
    (M_TreeNodeUtils_maybe.isVirtual(t) || M_TreeNodeUtils_maybe.isTop(t)
      ? "   "
      : String(t.lineNumber).padStart(3, " ")) + `:  ${i}`;
  const a = undefined === t.label ? "" : JSON.stringify(t.label);
  return M_TreeNodeUtils_maybe.isVirtual(t) || M_TreeNodeUtils_maybe.isTop(t)
...
exports.encodeTree = function e(t, r = "") {
  ...
  const o =
    !M_TreeNodeUtils_maybe.isBlank(t) && t.subs.length > 0
...
exports.firstLineOf = function e(t) {
  if (M_TreeNodeUtils_maybe.isLine(t) || M_TreeNodeUtils_maybe.isBlank(t))
    return t.lineNumber;
...
exports.lastLineOf = function e(t) {
  ...
  return undefined !== r ||
    M_TreeNodeUtils_maybe.isVirtual(t) ||
    M_TreeNodeUtils_maybe.isTop(t)
    ? r
    : t.lineNumber;
};
