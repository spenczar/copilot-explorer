...
function o(e, t) {
  ...
  if ("" === M_path.extname(r)) r += ".ts";
  else if (".ts" !== M_path.extname(r)) return null;
  return M_path.join(M_path.dirname(e), r);
}
function s(e) {
  let t = [];
...
function getDocComment(e, t) {
  const r = M_language_parser_utils_maybe.getFirstPrecedingComment(t);
...
function d(e, t) {
  ...
  const r =
    ...
    })(e, M_language_parser_utils_maybe.getFirstPrecedingComment(t) ?? t) ??
    "  ";
...
async function p(e, t, r) {
  ...
  if ("typescript" === t) {
    ...
    try {
      ...
      o = await M_language_parser_utils_maybe.parseTreeSitter(t, s);
      for (let e of M_language_parser_utils_maybe.queryExports(t, o.rootNode))
...
exports.extractLocalImportContext = async function (e, t) {
  ...
  return t && "typescript" === a
    ? (async function (e, t, r) {
        ...
        if (-1 === c) return a;
        e = e.substring(0, c);
        let l = await M_language_parser_utils_maybe.parseTreeSitter(n, e);
        try {
