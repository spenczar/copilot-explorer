...
const M_ParserInitializer_maybe = require("ParserInitializer");
const M_ParserInitializer_maybe = require("ParserInitializer");
var s;
!(function (e) {
  e.Python = "python";
...
async function getLanguage(e) {
  ...
  if (!y.has(t)) {
    const e = await (async function (e) {
      await M_ParserInitializer_maybe.init();
      ...
      return M_ParserInitializer_maybe.Language.load(t);
    })(t);
    y.set(t, e);
  }
  return y.get(t);
...
async function parseTreeSitter(e, t) {
  ...
  const n = new M_ParserInitializer_maybe();
  n.setLanguage(r);
  const o = n.parse(t);
  n.delete();
  return o;
