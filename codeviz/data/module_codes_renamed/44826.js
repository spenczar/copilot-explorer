  ...
  patch: function (e) {
    var t = e.instrument({
      operationIdGenerator: {
        next: function () {
          return M_ContextualFilterManager_maybe.channel.bindToContext(
            function (e) {
              return e();
            }
          );
    ...
    t.on("succeeded", function (e) {
      ...
      if ("function" == typeof e.operationId) {
        e.operationId(function () {
          return M_ContextualFilterManager_maybe.channel.publish("mongodb", {
            startedData: t,
            event: e,
            succeeded: true,
          });
        ...
        M_ContextualFilterManager_maybe.channel.publish("mongodb", {
          startedData: t,
          event: e,
          succeeded: true,
        });
...
exports.mongo3 = {
  ...
  patch: function (e) {
    ...
    t.on("started", function (e) {
      if (r[e.requestId]) {
        o[e.requestId] = M_ContextualFilterManager_maybe.channel.bindToContext(
          function (e) {
            return e();
          }
        );
...
exports.mongo330 = {
  ...
  patch: function (e) {
    ...
    t.on("started", function (e) {
      if (r[e.requestId]) {
        n[e.requestId] = M_ContextualFilterManager_maybe.channel.bindToContext(
          function (e) {
            return e();
          }
        );
