...
function s(e) {
  ...
  return {
    ...
    issuer: M_OptionsManager_maybe.pki.RDNAttributesAsArray(t.issuer),
    serialNumber: M_OptionsManager_maybe.util.createBuffer(t.serial).toHex(),
    encryptedContent: {
  ...
  for (r = [], o = 0, undefined; o < e.length; ++o) {
    ...
    r.push(
      ...
      i.create(i.Class.UNIVERSAL, i.Type.SEQUENCE, true, [
        ...
        i.create(i.Class.UNIVERSAL, i.Type.SEQUENCE, true, [
          M_OptionsManager_maybe.pki.distinguishedNameToAsn1({
            attributes: t.issuer,
          }),
          i.create(
            i.Class.UNIVERSAL,
            i.Type.INTEGER,
            false,
            M_OptionsManager_maybe.util.hexToBytes(t.serialNumber)
          ),
        ]),
        i.create(i.Class.UNIVERSAL, i.Type.SEQUENCE, true, [
          i.create(
  ...
  var t = i.create(i.Class.UNIVERSAL, i.Type.SEQUENCE, true, [
    ...
    i.create(i.Class.UNIVERSAL, i.Type.SEQUENCE, true, [
      ...
      i.create(
        ...
        i.Type.INTEGER,
        false,
        M_OptionsManager_maybe.util.hexToBytes(e.serialNumber)
      ),
    ]),
    i.create(i.Class.UNIVERSAL, i.Type.SEQUENCE, true, [
      i.create(
...
function l(e) {
  var t;
  if (e.type === M_OptionsManager_maybe.pki.oids.contentType)
    t = i.create(
      i.Class.UNIVERSAL,
      i.Type.OID,
      false,
  ...
  else if (e.type === M_OptionsManager_maybe.pki.oids.messageDigest)
    t = i.create(i.Class.UNIVERSAL, i.Type.OCTETSTRING, false, e.value.bytes());
  else if (e.type === M_OptionsManager_maybe.pki.oids.signingTime) {
...
function u(e, t, r) {
  ...
  if (i.derToOid(o.contentType) !== M_OptionsManager_maybe.pki.oids.data)
    throw new Error(
      "Unsupported PKCS#7 message. Only wrapped ContentType Data supported."
    );
  if (o.encryptedContent) {
    var a = "";
    if (M_OptionsManager_maybe.util.isArray(o.encryptedContent))
    ...
    e.encryptedContent = {
      ...
      parameter: M_OptionsManager_maybe.util.createBuffer(o.encParameter.value),
      content: M_OptionsManager_maybe.util.createBuffer(a),
    };
  }
  if (o.content) {
    a = "";
    if (M_OptionsManager_maybe.util.isArray(o.content))
    ...
    e.content = M_OptionsManager_maybe.util.createBuffer(a);
  }
...
function d(e) {
  ...
  if (undefined === e.content) {
    ...
    switch (e.encryptedContent.algorithm) {
      case M_OptionsManager_maybe.pki.oids["aes128-CBC"]:
      case M_OptionsManager_maybe.pki.oids["aes192-CBC"]:
      case M_OptionsManager_maybe.pki.oids["aes256-CBC"]:
        t = M_OptionsManager_maybe.aes.createDecryptionCipher(
          e.encryptedContent.key
        );
        break;
      case M_OptionsManager_maybe.pki.oids.desCBC:
      case M_OptionsManager_maybe.pki.oids["des-EDE3-CBC"]:
        t = M_OptionsManager_maybe.des.createDecryptionCipher(
          e.encryptedContent.key
        );
        break;
      default:
...
o.messageFromAsn1 = function (e) {
  ...
  switch (c) {
    case M_OptionsManager_maybe.pki.oids.envelopedData:
      a = o.createEnvelopedData();
      break;
    case M_OptionsManager_maybe.pki.oids.encryptedData:
      a = o.createEncryptedData();
      break;
    case M_OptionsManager_maybe.pki.oids.signedData:
...
o.createSignedData = function () {
  var e = null;
  return (e = {
    type: M_OptionsManager_maybe.pki.oids.signedData,
    version: 1,
    certificates: [],
    crls: [],
    signers: [],
    ...
    fromAsn1: function (t) {
      ...
      if (e.rawCapture.certificates)
        for (var r = e.rawCapture.certificates.value, i = 0; i < r.length; ++i)
          e.certificates.push(
            M_OptionsManager_maybe.pki.certificateFromAsn1(r[i])
          );
    },
    toAsn1: function () {
      if (e.contentInfo) {
      ...
      for (t = [], r = 0, undefined; r < e.certificates.length; ++r) {
        var t;
        var r;
        t.push(M_OptionsManager_maybe.pki.certificateToAsn1(e.certificates[r]));
      }
      var o = [];
    ...
    addSigner: function (t) {
      ...
      if (t.certificate) {
        var o = t.certificate;
        if ("string" == typeof o) {
          o = M_OptionsManager_maybe.pki.certificateFromPem(o);
        }
      ...
      var a = t.digestAlgorithm || M_OptionsManager_maybe.pki.oids.sha1;
      switch (a) {
        case M_OptionsManager_maybe.pki.oids.sha1:
        case M_OptionsManager_maybe.pki.oids.sha256:
        case M_OptionsManager_maybe.pki.oids.sha384:
        case M_OptionsManager_maybe.pki.oids.sha512:
        case M_OptionsManager_maybe.pki.oids.md5:
          break;
        default:
          throw new Error(
      ...
      if (c.length > 0) {
        for (l = false, u = false, d = 0, undefined; d < c.length; ++d) {
          ...
          var d;
          var p = c[d];
          if (l || p.type !== M_OptionsManager_maybe.pki.oids.contentType) {
            if (u || p.type !== M_OptionsManager_maybe.pki.oids.messageDigest);
            else {
              u = true;
              if (l) break;
            }
      ...
      e.signers.push({
        ...
        serialNumber: i,
        digestAlgorithm: a,
        signatureAlgorithm: M_OptionsManager_maybe.pki.oids.rsaEncryption,
        signature: null,
      ...
      if ("object" != typeof e.content || null === e.contentInfo) {
        e.contentInfo = i.create(i.Class.UNIVERSAL, i.Type.SEQUENCE, true, [
          i.create(
            ...
            i.Type.OID,
            false,
            i.oidToDer(M_OptionsManager_maybe.pki.oids.data).getBytes()
          ),
        ]);
        if ("content" in e) {
          if (e.content instanceof M_OptionsManager_maybe.util.ByteBuffer) {
            r = e.content.bytes();
          } else {
            if ("string" == typeof e.content) {
              r = M_OptionsManager_maybe.util.encodeUtf8(e.content);
            }
          }
          if (t.detached) {
        ...
        (function (t) {
          ...
          for (u = new Date(), d = 0, undefined; d < e.signers.length; ++d) {
            ...
            if (0 === p.authenticatedAttributes.length) {
              if (o !== M_OptionsManager_maybe.pki.oids.data)
                throw new Error(
              ...
              for (
                ...
                if (g.type === M_OptionsManager_maybe.pki.oids.messageDigest) {
                  g.value = t[p.digestAlgorithm].digest();
                } else {
                  if (g.type === M_OptionsManager_maybe.pki.oids.signingTime) {
                    if (g.value) {
                      g.value = u;
                    }
                  }
          ...
          (function () {
            for (t = {}, r = 0, undefined; r < e.signers.length; ++r) {
              ...
              if ((s = o.digestAlgorithm) in t) {
                t[s] =
                  M_OptionsManager_maybe.md[
                    M_OptionsManager_maybe.pki.oids[s]
                  ].create();
              }
    ...
    addCertificate: function (t) {
      if ("string" == typeof t) {
        t = M_OptionsManager_maybe.pki.certificateFromPem(t);
      }
...
o.createEncryptedData = function () {
  var e = null;
  return (e = {
    type: M_OptionsManager_maybe.pki.oids.encryptedData,
    version: 0,
    encryptedContent: {
      algorithm: M_OptionsManager_maybe.pki.oids["aes256-CBC"],
    },
    fromAsn1: function (t) {
...
o.createEnvelopedData = function () {
  var e = null;
  return (e = {
    type: M_OptionsManager_maybe.pki.oids.envelopedData,
    version: 0,
    recipients: [],
    encryptedContent: {
      algorithm: M_OptionsManager_maybe.pki.oids["aes256-CBC"],
    ...
    decrypt: function (t, r) {
      if (
        ...
        switch (t.encryptedContent.algorithm) {
          case M_OptionsManager_maybe.pki.oids.rsaEncryption:
          case M_OptionsManager_maybe.pki.oids.desCBC:
            var i = r.decrypt(t.encryptedContent.content);
            e.encryptedContent.key =
              M_OptionsManager_maybe.util.createBuffer(i);
            break;
          default:
            throw new Error(
    ...
    addRecipient: function (t) {
      e.recipients.push({
        ...
        encryptedContent: {
          algorithm: M_OptionsManager_maybe.pki.oids.rsaEncryption,
          key: t.publicKey,
        },
      });
    },
      ...
      if (undefined === e.encryptedContent.content) {
        ...
        switch (
          ...
          case M_OptionsManager_maybe.pki.oids["aes128-CBC"]:
            i = 16;
            o = 16;
            s = M_OptionsManager_maybe.aes.createEncryptionCipher;
            break;
          case M_OptionsManager_maybe.pki.oids["aes192-CBC"]:
            i = 24;
            o = 16;
          ...
          case M_OptionsManager_maybe.pki.oids["des-EDE3-CBC"]:
            i = 24;
            o = 8;
            s = M_OptionsManager_maybe.des.createEncryptionCipher;
            break;
          default:
        ...
        if (undefined === t)
          t = M_OptionsManager_maybe.util.createBuffer(
            M_OptionsManager_maybe.random.getBytes(i)
          );
        else if (t.length() != i)
          throw new Error(
        ...
        e.encryptedContent.key = t;
        e.encryptedContent.parameter = M_OptionsManager_maybe.util.createBuffer(
          M_OptionsManager_maybe.random.getBytes(o)
        );
        var a = s(t);
      ...
      for (var c = 0; c < e.recipients.length; ++c) {
        ...
        if (undefined === l.encryptedContent.content) {
          if (
            ...
            M_OptionsManager_maybe.pki.oids.rsaEncryption
          )
            throw new Error(
              "Unsupported asymmetric cipher, OID " +
                l.encryptedContent.algorithm
