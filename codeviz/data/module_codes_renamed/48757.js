...
require("Sha512CryptoModule");
require("binary-data-reader");
var M_ASN1_Validator_maybe = require("ASN1-Validator");
var o = M_ASN1_Validator_maybe.publicKeyValidator;
var s = M_ASN1_Validator_maybe.privateKeyValidator;
if (undefined === a) var a = M_OptionsManager_maybe.jsbn.BigInteger;
var c = M_OptionsManager_maybe.util.ByteBuffer;
var l = "undefined" == typeof Buffer ? Uint8Array : Buffer;
M_OptionsManager_maybe.pki = M_OptionsManager_maybe.pki || {};
module.exports =
  M_OptionsManager_maybe.pki.ed25519 =
  M_OptionsManager_maybe.ed25519 =
    M_OptionsManager_maybe.ed25519 || {};
var u = M_OptionsManager_maybe.ed25519;
function d(e) {
  var t = e.message;
...
u.generateKeyPair = function (e) {
  var t = (e = e || {}).seed;
  if (undefined === t)
    t = M_OptionsManager_maybe.random.getBytesSync(
...
u.privateKeyFromAsn1 = function (e) {
  var t = {};
  var r = [];
  if (!M_OptionsManager_maybe.asn1.validate(e, s, t, r)) {
    var i = new Error("Invalid Key.");
    throw ((i.errors = r), i);
  }
  var o = M_OptionsManager_maybe.asn1.derToOid(t.privateKeyOid);
  var a = M_OptionsManager_maybe.oids.EdDSA25519;
  if (o !== a)
    throw new Error('Invalid OID "' + o + '"; OID must be "' + a + '".');
  var c = t.privateKey;
  return {
    privateKeyBytes: d({
      message: M_OptionsManager_maybe.asn1.fromDer(c).value,
      encoding: "binary",
    }),
  };
};
u.publicKeyFromAsn1 = function (e) {
  var t = {};
  var r = [];
  if (!M_OptionsManager_maybe.asn1.validate(e, o, t, r)) {
    var i = new Error("Invalid Key.");
    throw ((i.errors = r), i);
  }
  var s = M_OptionsManager_maybe.asn1.derToOid(t.publicKeyOid);
  var a = M_OptionsManager_maybe.oids.EdDSA25519;
  if (s !== a)
...
function b(e, t) {
  var r = M_OptionsManager_maybe.md.sha512.create();
  var i = new c(e);
