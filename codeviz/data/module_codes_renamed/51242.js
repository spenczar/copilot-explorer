...
(module.exports = M_OptionsManager_maybe.pss =
  M_OptionsManager_maybe.pss || {}).create = function (e) {
  ...
  var a = e.prng || M_OptionsManager_maybe.random;
  var c = {
    encode: function (e, c) {
      var l;
      var u;
      ...
      var f = new M_OptionsManager_maybe.util.ByteBuffer();
      f.fillWithByte(0, 8);
      f.putBytes(h);
      f.putBytes(u);
      r.start();
      ...
      var m = new M_OptionsManager_maybe.util.ByteBuffer();
