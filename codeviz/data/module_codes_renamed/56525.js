...
(exports.MessageReader || (exports.MessageReader = {})).is = function (e) {
  ...
  return (
    t &&
    M_TypeChecker_maybe.func(t.listen) &&
    M_TypeChecker_maybe.func(t.dispose) &&
    M_TypeChecker_maybe.func(t.onError) &&
    M_TypeChecker_maybe.func(t.onClose) &&
    M_TypeChecker_maybe.func(t.onPartialMessage)
  );
};
class AbstractMessageReader {
  constructor() {
    this.errorEmitter = new M_EventEmitterManager_maybe.Emitter();
    this.closeEmitter = new M_EventEmitterManager_maybe.Emitter();
    this.partialMessageEmitter = new M_EventEmitterManager_maybe.Emitter();
  }
  dispose() {
    ...
    return e instanceof Error
      ...
      : new Error(
          `Reader received error. Reason: ${
            M_TypeChecker_maybe.string(e.message) ? e.message : "unknown"
          }`
        );
  }
}
...
(function (e) {
  e.fromOptions = function (e) {
    ...
    if (undefined === s) {
      s =
        M_RuntimeAbstractionLayerManager_maybe.default().applicationJson
          .decoder;
      a.set(s.name, s);
    }
    return {
...
exports.ReadableStreamMessageReader = class extends AbstractMessageReader {
  constructor(e, t) {
    ...
    this.buffer =
      M_RuntimeAbstractionLayerManager_maybe.default().messageBuffer.create(
  ...
  clearPartialMessageTimer() {
    if (this.partialMessageTimer) {
      M_RuntimeAbstractionLayerManager_maybe.default().timer.clearTimeout(
  ...
  setPartialMessageTimer() {
    ...
    if (this._partialMessageTimeout <= 0) {
      this.partialMessageTimer =
        M_RuntimeAbstractionLayerManager_maybe.default().timer.setTimeout(
          (e, t) => {
            this.partialMessageTimer = undefined;
