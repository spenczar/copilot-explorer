...
const M_AbortSignalManager_maybe = require("AbortSignalManager");
const a = require("Environment-Dependent-Module")("helix-fetch:core");
const { RequestAbortedError: c } = require("ErrorClassesModule");
const M_helix_fetch_h1_maybe = require("helix-fetch-h1");
const M_http2_fetch_helper_maybe = require("http2-fetch-helper");
const M_LockManager_maybe = require("LockManager");
const { isPlainObject: p } = require("Object-Size-Calculator");
const {
  isFormData: h,
  FormDataSerializer: f,
} = require("FormDataSerializerModule");
const { version: g } = require("helix-fetch-parser");
const m = "h2";
const y = "h2c";
const v = "http/1.0";
const _ = "http/1.1";
...
module.exports = {
  request: async (e, t, r) => {
    ...
    switch ((a(`${i.host} -> ${g}`), g)) {
      case m:
        try {
          return await M_http2_fetch_helper_maybe.request(
            e,
            i,
            b
              ? {
      ...
      case y:
        return M_http2_fetch_helper_maybe.request(
          e,
      ...
      case v:
      case _:
        return M_helix_fetch_h1_maybe.request(
          e,
          i,
          b
            ? {
  ...
  setupContext: (e) => {
    ...
    e.alpnProtocols = t;
    e.alpnCache = new M_AbortSignalManager_maybe({
      max: n,
      ttl: r,
    });
    e.userAgent = i;
    e.socketFactory = o;
    M_helix_fetch_h1_maybe.setupContext(e);
    M_http2_fetch_helper_maybe.setupContext(e);
  },
  resetContext: async (e) => (
    e.alpnCache.clear(),
    Promise.all([
      M_helix_fetch_h1_maybe.resetContext(e),
      M_http2_fetch_helper_maybe.resetContext(e),
    ])
  ),
