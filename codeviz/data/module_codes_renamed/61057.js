...
i.create = function (e, t, r, o, s) {
  if (M_OptionsManager_maybe.util.isArray(o)) {
  ...
  var l = {
    ...
    type: t,
    constructed: r,
    composed: r || M_OptionsManager_maybe.util.isArray(o),
    value: o,
  };
...
i.equals = function (e, t, r) {
  if (M_OptionsManager_maybe.util.isArray(e)) {
    if (!M_OptionsManager_maybe.util.isArray(t)) return false;
...
i.validate = function (e, t, r, o) {
  ...
  if (
    ...
    s = true;
    if (t.value && M_OptionsManager_maybe.util.isArray(t.value))
    ...
    if (((o += s + "Value: "), e.type === i.Type.OID)) {
      ...
      (o += d),
        M_OptionsManager_maybe.pki &&
          M_OptionsManager_maybe.pki.oids &&
          d in M_OptionsManager_maybe.pki.oids &&
          (o += " (" + M_OptionsManager_maybe.pki.oids[d] + ") ");
    }
    if (e.type === i.Type.INTEGER)
      try {
        o += i.derToInteger(e.value);
      } catch (t) {
        o += "0x" + M_OptionsManager_maybe.util.bytesToHex(e.value);
      }
    else if (e.type === i.Type.BITSTRING) {
      if (
        (e.value.length > 1
          ? (o +=
              "0x" + M_OptionsManager_maybe.util.bytesToHex(e.value.slice(1)))
          : (o += "(none)"),
        e.value.length > 0)
      ) {
      ...
      try {
        o += M_OptionsManager_maybe.util.decodeUtf8(e.value);
      } catch (t) {
        if ("URI malformed" !== t.message) throw t;
        o +=
          "0x" +
          M_OptionsManager_maybe.util.bytesToHex(e.value) +
          " (malformed UTF8)";
      }
    else
