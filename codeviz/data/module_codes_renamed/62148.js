...
function i(e, t) {
  M_OptionsManager_maybe.cipher.registerAlgorithm(e, function () {
    return new M_OptionsManager_maybe.des.Algorithm(e, t);
  });
}
require("Cipher-Algorithm-Manager");
require("CipherModesModule");
require("binary-data-reader");
module.exports = M_OptionsManager_maybe.des = M_OptionsManager_maybe.des || {};
M_OptionsManager_maybe.des.startEncrypting = function (e, t, r, n) {
  var i = f({
    key: e,
    output: r,
    decrypt: false,
...
M_OptionsManager_maybe.des.createEncryptionCipher = function (e, t) {
  return f({
    key: e,
    output: null,
    decrypt: false,
...
M_OptionsManager_maybe.des.startDecrypting = function (e, t, r, n) {
  var i = f({
    key: e,
    output: r,
    decrypt: true,
...
M_OptionsManager_maybe.des.createDecryptionCipher = function (e, t) {
  return f({
    key: e,
    output: null,
    decrypt: true,
...
M_OptionsManager_maybe.des.Algorithm = function (e, t) {
  var r = this;
  r.name = e;
  r.mode = new t({
    blockSize: 8,
...
M_OptionsManager_maybe.des.Algorithm.prototype.initialize = function (e) {
  if (!this._init) {
    var t = M_OptionsManager_maybe.util.createBuffer(e.key);
...
i("DES-ECB", M_OptionsManager_maybe.cipher.modes.ecb);
i("DES-CBC", M_OptionsManager_maybe.cipher.modes.cbc);
i("DES-CFB", M_OptionsManager_maybe.cipher.modes.cfb);
i("DES-OFB", M_OptionsManager_maybe.cipher.modes.ofb);
i("DES-CTR", M_OptionsManager_maybe.cipher.modes.ctr);
i("3DES-ECB", M_OptionsManager_maybe.cipher.modes.ecb);
i("3DES-CBC", M_OptionsManager_maybe.cipher.modes.cbc);
i("3DES-CFB", M_OptionsManager_maybe.cipher.modes.cfb);
i("3DES-OFB", M_OptionsManager_maybe.cipher.modes.ofb);
i("3DES-CTR", M_OptionsManager_maybe.cipher.modes.ctr);
var o = [
