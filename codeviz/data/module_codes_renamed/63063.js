...
require("hmac-util");
var i = (module.exports = M_OptionsManager_maybe.tls);
function o(e, t, r) {
  var o = t.entity === M_OptionsManager_maybe.tls.ConnectionEnd.client;
  e.read.cipherState = {
    init: false,
    cipher: M_OptionsManager_maybe.cipher.createDecipher(
      "AES-CBC",
  ...
  e.write.cipherState = {
    init: false,
    cipher: M_OptionsManager_maybe.cipher.createCipher(
      "AES-CBC",
  ...
  r =
    e.version.minor === i.Versions.TLS_1_0.minor
      ? t.cipherState.init
        ? null
        : t.cipherState.iv
      : M_OptionsManager_maybe.random.getBytesSync(16);
...
function l(e, t) {
  ...
  o = s.finish(c);
  var a = t.macLength;
  var l = M_OptionsManager_maybe.random.getBytesSync(a);
  ...
  e.fragment = M_OptionsManager_maybe.util.createBuffer(e.fragment);
  e.length = e.fragment.length();
