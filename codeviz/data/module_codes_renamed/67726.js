  ...
  patch: function (e, t) {
    ...
    e.Client.prototype.query = function (e, t, s) {
      ...
      function u(e) {
        ...
        var t = M_ContextualFilterManager_maybe.channel.bindToContext(function (
          t,
          r
        ) {
          ...
          M_ContextualFilterManager_maybe.channel.publish("postgres", c);
          if (t) {
    ...
    e.Client.prototype.query = function (e, t, s) {
      ...
      function p(e) {
        ...
        var t = M_ContextualFilterManager_maybe.channel.bindToContext(function (
          ...
          M_ContextualFilterManager_maybe.channel.publish("postgres", u);
          if (t) {
            if (e) return e.apply(this, arguments);
            a && a instanceof M_events.EventEmitter && a.emit("error", t);
          } else e && e.apply(this, arguments);
