...
var o = M_OptionsManager_maybe.util.isNodejs ? require("crypto") : null;
var s = M_OptionsManager_maybe.asn1;
var a = M_OptionsManager_maybe.util;
M_OptionsManager_maybe.pki = M_OptionsManager_maybe.pki || {};
module.exports =
  M_OptionsManager_maybe.pki.rsa =
  M_OptionsManager_maybe.rsa =
    M_OptionsManager_maybe.rsa || {};
var c = M_OptionsManager_maybe.pki;
...
var h = (M_OptionsManager_maybe.pki.rsa.publicKeyValidator = {
...
var m = function (e, t, r) {
  ...
  do {
    o = new i(
      M_OptionsManager_maybe.util.bytesToHex(
        M_OptionsManager_maybe.random.getBytes(t.n.bitLength() / 8)
      ),
      16
    );
...
function y(e, t, r) {
  ...
  if (0 === r || 1 === r) {
    ...
    for (; c > 0; ) {
      var u = 0;
      var d = M_OptionsManager_maybe.random.getBytes(c);
      for (l = 0; l < c; ++l)
...
function v(e, t, r, i) {
  var o = Math.ceil(t.n.bitLength() / 8);
  var s = M_OptionsManager_maybe.util.createBuffer(e);
  var a = s.getByte();
  var c = s.getByte();
  if (
    0 !== a ||
...
function _(e, t, r) {
  ...
  function a(e, t) {
    M_OptionsManager_maybe.prime.generateProbablePrime(e, o, t);
  }
  function l(t, n) {
    if (t) return r(t);
    e.q = n;
...
function b(e) {
  ...
  var r = M_OptionsManager_maybe.util.hexToBytes(t);
  return r.length > 1 &&
...
function C(e) {
  return M_OptionsManager_maybe.util.isNodejs && "function" == typeof o[e];
}
function E(e) {
  return (
...
function S(e) {
  for (
    t = M_OptionsManager_maybe.util.hexToBytes(e.toString(16)),
...
c.rsa.encrypt = function (e, t, r) {
  ...
  if (false !== r && true !== r) {
    ...
    (o = M_OptionsManager_maybe.util.createBuffer()).putBytes(e);
  }
  for (
    c = new i(o.toHex(), 16),
      l = m(c, t, s).toString(16),
      u = M_OptionsManager_maybe.util.createBuffer(),
  ...
  u.putBytes(M_OptionsManager_maybe.util.hexToBytes(l));
  return u.getBytes();
};
c.rsa.decrypt = function (e, t, r, o) {
  ...
  var c = new i(M_OptionsManager_maybe.util.createBuffer(e).toHex(), 16);
...
c.rsa.createKeyPairGenerationState = function (e, t, r) {
  ...
  e = e || 2048;
  var o;
  var s = (r = r || {}).prng || M_OptionsManager_maybe.random;
  var a = {
          ...
          .then(function (e) {
            if (e) {
              var t = c.privateKeyFromAsn1(
                s.fromDer(M_OptionsManager_maybe.util.createBuffer(e))
              );
              i(null, {
                privateKey: t,
            ...
            (r.oncomplete = function (e) {
              var t = e.target.result,
                r = c.privateKeyFromAsn1(
                  s.fromDer(M_OptionsManager_maybe.util.createBuffer(t))
                );
              i(null, {
                privateKey: r,
  ...
  var r = {
    ...
    encrypt: function (e, t, i) {
      ...
      if ("RSAES-PKCS1-V1_5" === t)
        ...
        t = {
          encode: function (e, t) {
            return M_OptionsManager_maybe.pkcs1.encode_rsa_oaep(t, e, i);
          },
        };
      ...
      if ("RSASSA-PKCS1-V1_5" === i) {
        i = {
          verify: function (e, t) {
            ...
            if (
              u !== M_OptionsManager_maybe.oids.md2 &&
              u !== M_OptionsManager_maybe.oids.md5 &&
              u !== M_OptionsManager_maybe.oids.sha1 &&
              u !== M_OptionsManager_maybe.oids.sha224 &&
              u !== M_OptionsManager_maybe.oids.sha256 &&
              u !== M_OptionsManager_maybe.oids.sha384 &&
              u !== M_OptionsManager_maybe.oids.sha512 &&
              u !== M_OptionsManager_maybe.oids["sha512-224"] &&
              u !== M_OptionsManager_maybe.oids["sha512-256"]
            )
              throw (
                (((l = new Error(
  ...
  var u = {
    ...
    decrypt: function (e, t, r) {
      ...
      if ("RSAES-PKCS1-V1_5" === t)
        ...
        t = {
          decode: function (e, t) {
            return M_OptionsManager_maybe.pkcs1.decode_rsa_oaep(t, e, r);
          },
        };
      else {
...
c.privateKeyFromAsn1 = function (e) {
  ...
  if (s.validate(e, u, g, m)) {
    e = s.fromDer(M_OptionsManager_maybe.util.createBuffer(g.privateKey));
  }
  g = {};
  m = [];
  ...
  t = M_OptionsManager_maybe.util.createBuffer(g.privateKeyModulus).toHex();
  r = M_OptionsManager_maybe.util
    .createBuffer(g.privateKeyPublicExponent)
    .toHex();
  o = M_OptionsManager_maybe.util
    .createBuffer(g.privateKeyPrivateExponent)
    .toHex();
  a = M_OptionsManager_maybe.util.createBuffer(g.privateKeyPrime1).toHex();
  l = M_OptionsManager_maybe.util.createBuffer(g.privateKeyPrime2).toHex();
  p = M_OptionsManager_maybe.util.createBuffer(g.privateKeyExponent1).toHex();
  h = M_OptionsManager_maybe.util.createBuffer(g.privateKeyExponent2).toHex();
  f = M_OptionsManager_maybe.util.createBuffer(g.privateKeyCoefficient).toHex();
...
c.publicKeyFromAsn1 = function (e) {
  ...
  var l = M_OptionsManager_maybe.util.createBuffer(t.publicKeyModulus).toHex();
  var u = M_OptionsManager_maybe.util.createBuffer(t.publicKeyExponent).toHex();
