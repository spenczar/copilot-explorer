...
(function () {
  ...
  var d = (o.DES = i.extend({
    _doReset: function () {
      for (e = this._key.words, t = [], r = 0, undefined; r < 56; r++) {
        var e;
        var t;
        var r;
        var n = s[r] - 1;
      ...
      for (i = this._subKeys = [], o = 0, undefined; o < 16; o++) {
        var i;
        var o;
        var l = (i[o] = []);
        var u = c[o];
        for (r = 0; r < 24; r++) {
          l[(r / 6) | 0] |= t[(a[r] - 1 + u) % 28] << (31 - (r % 6));
          l[4 + ((r / 6) | 0)] |=
            t[28 + ((a[r + 24] - 1 + u) % 28)] << (31 - (r % 6));
        }
    ...
    _doCryptBlock: function (e, t, r) {
      ...
      for (var n = 0; n < 16; n++) {
        for (
          i = r[n], o = this._lBlock, s = this._rBlock, a = 0, c = 0, undefined;
          c < 8;
          c++
        ) {
          var i;
  ...
  var f = (o.TripleDES = i.extend({
    _doReset: function () {
      ...
      this._des1 = d.createEncryptor(r.create(t));
...
module.exports = M_SecureRandomNumberGenerator_maybe.TripleDES;
