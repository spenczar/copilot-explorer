...
(function () {
  if (M_OptionsManager_maybe.prime)
    module.exports = M_OptionsManager_maybe.prime;
  else {
    var t =
      (module.exports =
      M_OptionsManager_maybe.prime =
        M_OptionsManager_maybe.prime || {});
    var r = M_OptionsManager_maybe.jsbn.BigInteger;
    ...
    t.generateProbablePrime = function (e, t, i) {
      ...
      o.options = o.options || {};
      var s = t.prng || M_OptionsManager_maybe.random;
      var c = {
        ...
        return (function (e, t, i, o) {
          return "workers" in i
            ? (function (e, t, i, o) {
                ...
                if (-1 === c)
                  return M_OptionsManager_maybe.util.estimateCores(function (
                    e,
                    t
                  ) {
                    if (e) {
  ...
  function c(e, t, r, o, s, a, u) {
    ...
    M_OptionsManager_maybe.util.setImmediate(function () {
      c(e, t, r, o, s, a, u);
    });
  }
  function l(e, t) {
