...
var AutoCollectNativePerformance = (function () {
  ...
  e.parseEnabled = function (e) {
    var t =
      process.env[M_AppInsightsConfigManager_maybe.ENV_nativeMetricsDisableAll];
    var r =
      process.env[M_AppInsightsConfigManager_maybe.ENV_nativeMetricsDisablers];
    if (t)
      return {
        isEnabled: false,
        disabledMetrics: {},
        ...
        this._client.trackMetric({
          ...
          tagOverrides:
            ...
            (t[this._client.context.keys.internalSdkVersion] =
              "node-nativeperf:" + M_ContextTagManager_maybe.sdkVersion),
            t),
        });
      }
    }
