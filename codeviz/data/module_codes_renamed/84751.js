...
const s = require("Environment-Dependent-Module")("helix-fetch:h1");
const { RequestAbortedError: a } = require("ErrorClassesModule");
const { decodeStream: c } = require("Object-Size-Calculator");
module.exports = {
  request: async (e, t, r) => {
    ...
    const u = ((e, t) => {
      ...
      return "https:" === t
        ? r.httpsAgent
          ? r.httpsAgent
          : o || "boolean" == typeof s
          ? ((r.httpsAgent = new M_https.Agent(
              "boolean" == typeof s
                ? {
                    ...(o || {}),
        ...
        ? r.httpAgent
        : o
        ? ((r.httpAgent = new M_http.Agent(o)), r.httpAgent)
        : undefined;
    })(e, t.protocol);
    const d = {
      ...r,
