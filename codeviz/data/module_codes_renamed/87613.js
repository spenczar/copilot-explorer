...
function resolve(e, t, r, n) {
  ...
  return new Promise((l, u) => {
    ...
    if (t && M_fs.existsSync(t)) {
      if (p[a]) {
        p[a] = t + M_path.delimiter + p[a];
      } else {
        p[a] = t;
      }
      if (n) {
...
function resolveGlobalNodePath(e) {
  ...
  try {
    ...
    let r = M_child_process.spawnSync(t, ["config", "get", "prefix"], n).stdout;
    if (!r)
    ...
    return c.length > 0
      ? a()
        ? M_path.join(c, "node_modules")
        : M_path.join(c, "lib", "node_modules")
      : undefined;
  } catch (e) {
    return;
  } finally {
...
exports.uriToFilePath = function (e) {
  ...
  return M_path.normalize(r.join("/"));
};
...
exports.resolveGlobalYarnPath = function (e) {
  ...
  try {
    ...
    let o = M_child_process.spawnSync(t, ["global", "dir", "--json"], r);
    let a = o.stdout;
    if (!a)
      return void (
        e &&
    ...
    for (let e of c)
      try {
        let t = JSON.parse(e);
        if ("log" === t.type) return M_path.join(t.data, "node_modules");
      } catch (e) {}
    return;
  } catch (e) {
    return;
...
(function (e) {
  ...
  function r() {
    if (undefined !== t) {
      t = !(
        ...
        (M_fs.existsSync(__filename.toUpperCase()) &&
          M_fs.existsSync(__filename.toLowerCase()))
      );
    }
    return t;
  }
  ...
  e.isParent = function (e, t) {
    return r()
      ? 0 === M_path.normalize(t).indexOf(M_path.normalize(e))
      : 0 ===
          M_path.normalize(t)
            .toLowerCase()
            .indexOf(M_path.normalize(e).toLowerCase());
  };
})((u = exports.FileSystem || (exports.FileSystem = {})));
exports.resolveModulePath = function (e, t, r, n) {
  return r
    ? (M_path.isAbsolute(r) || (r = M_path.join(e, r)),
      resolve(t, r, r, n)
        .then((e) =>
          u.isParent(r, e)
            ? e
