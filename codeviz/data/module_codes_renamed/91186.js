...
exports.computeScore =
  ...
  exports.FixedWindowSizeJaccardMatcher =
    undefined;
const M_WindowDelineationManager_maybe = require("WindowDelineationManager");
const M_contextual_tokenizer_manager_maybe = require("contextual-tokenizer-manager");
class FixedWindowSizeJaccardMatcher extends M_contextual_tokenizer_manager_maybe.WindowedMatcher {
  constructor(e, t) {
    super(e);
    this.windowLength = t;
  }
...
class IndentationBasedJaccardMatcher extends M_contextual_tokenizer_manager_maybe.WindowedMatcher {
  constructor(e, t, r) {
    super(e);
  ...
  getWindowsDelineations(e) {
    return M_WindowDelineationManager_maybe.getWindowsDelineations(
      e,
      this.languageId,
...
class FunctionJaccardMatcher extends M_contextual_tokenizer_manager_maybe.FunctionalMatcher {
  id() {
    return "function";
  }
  getWindowsDelineations(e) {
