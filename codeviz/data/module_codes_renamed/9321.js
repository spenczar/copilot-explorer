...
exports.createRequestContext = async function (e, t) {
  ...
  if (void 0 === r) {
    ...
    if ("OK" !== t.status)
      return {
        code: M_AjvErrorManager_maybe.ErrorCode.NoCopilotToken,
        message: `Not authenticated: ${t.status}`,
      };
    if (((r = e.get(AuthManager).getCopilotTokenManager()), void 0 === r))
      return {
        code: M_AjvErrorManager_maybe.ErrorCode.InternalError,
        message: "Unexpected missing Copilot token",
      };
  }
  const a = new M_ContextManager_maybe.Context(e);
  a.forceSet(M_CopilotTokenManagerModule_maybe.CopilotTokenManager, r);
  return a;
};
