...
class i {
  ...
  async getNodeMatchAtPosition(e, t, r) {
    const i = await M_language_parser_utils_maybe.parseTreeSitter(
      this.languageId,
      e
    );
    try {
  ...
  isBlockEmpty(e, t) {
    ...
    return (
      ...
      !(
        ...
        1 != e.children.length ||
        !M_language_parser_utils_maybe.queryPythonIsDocstring(e.parent)
      )
    );
  }
  async isEmptyBlockStart(e, t) {
    ...
    t = s(e, t);
    const r = await M_language_parser_utils_maybe.parseTreeSitter(
      this.languageId,
      e
    );
    try {
...
function getBlockParser(e) {
  return u[M_language_parser_utils_maybe.languageIdToWasmLanguage(e)];
}
exports.getBlockParser = getBlockParser;
exports.isEmptyBlockStart = async function (e, t, r) {
  return (
    !!M_language_parser_utils_maybe.isSupportedLanguageId(e) &&
    getBlockParser(e).isEmptyBlockStart(t, r)
  );
};
exports.isBlockBodyFinished = async function (e, t, r, i) {
  if (M_language_parser_utils_maybe.isSupportedLanguageId(e))
    return getBlockParser(e).isBlockBodyFinished(t, r, i);
};
exports.getNodeStart = async function (e, t, r) {
  if (M_language_parser_utils_maybe.isSupportedLanguageId(e))
    return getBlockParser(e).getNodeStart(t, r);
};
