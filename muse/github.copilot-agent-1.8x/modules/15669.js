...
const i = require(59187);
var o = require(66545);
exports._ = o._;
exports.str = o.str;
exports.strConcat = o.strConcat;
exports.nil = o.nil;
exports.getProperty = o.getProperty;
exports.stringify = o.stringify;
exports.regexpCode = o.regexpCode;
exports.Name = o.Name;
var s = require(59187);
...
function R(e, t, r) {
  return e instanceof n.Name
    ? o(e)
    : (i = e) instanceof n._Code &&
      i._items.some(
        (e) => e instanceof n.Name && 1 === t[e.str] && undefined !== r[e.str]
      )
    ? new n._Code(
        e._items.reduce(
          (e, t) => (
            t instanceof n.Name && (t = o(t)),
...
function M(e) {
  return (t, r) =>
    t === n.nil ? r : r === n.nil ? t : n._`${B(t)} ${e} ${B(r)}`;
}
function B(e) {
