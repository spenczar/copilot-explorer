...
exports.NeighborSource =
  ...
  exports.NeighborFileType =
    undefined;
const n = require(16630);
const i = require(25225);
var o;
var s;
!(function (e) {
  e.Open = "Open";
...
class NeighborSource {
  ...
  async tryGetTextDocument(e, t) {
    try {
      return await e.getTextDocument(n.URI.parse(t));
    } catch (e) {
      return;
    }
  }
  async getCursorHistoryFiles(e, t, r, n) {
    ...
    const c = [...i.cursorHistoryStack].reverse();
    if (n === s.MostRecent) {
      let n = 0;
      const i = new Set();
  ...
  async getOpenFiles(e, t, r) {
    const n = [];
    const o = i.sortByAccessTimes(e.textDocuments);
    let s = 0;
    for (const i of o)
      if (
