...
exports.CodeGen =
  ...
  exports.KeywordCxt =
    undefined;
var n = require(91686);
exports.KeywordCxt = n.KeywordCxt;
var i = require(15669);
exports._ = i._;
exports.str = i.str;
...
exports.nil = i.nil;
exports.Name = i.Name;
exports.CodeGen = i.CodeGen;
const o = require(46448);
const s = require(91578);
const a = require(82881);
const c = require(87382);
const l = require(15669);
const u = require(96696);
const d = require(97332);
const p = require(88936);
const h = require(71143);
const f = require(10407);
...
function b(e) {
  ...
  const R =
    ...
    undefined !== n
      ? n
      : g;
  const N = null !== (i = e.uriResolver) && undefined !== i ? i : f.default;
  return {
    strictSchema:
...
class w {
  ...
  getSchema(e) {
    ...
    if (undefined === t) {
      ...
      const n = new c.SchemaEnv({
        schema: {},
        schemaId: r,
      });
      t = c.resolveSchema.call(this, n, e);
      if (!t) return;
      this.refs[e] = t;
    }
  ...
  addKeyword(e, t) {
    ...
    P.call(this, r, t);
    if (!t) return (0, p.eachItem)(r, (e) => R.call(this, e)), this;
    O.call(this, t);
    const n = {
      ...t,
