...
var o = n.asn1;
var s = (n.pki = n.pki || {});
module.exports = s.pbe = n.pbe = n.pbe || {};
var a = s.oids;
var c = {
...
s.encryptPrivateKeyInfo = function (e, t, r) {
  ...
  var c;
  var l;
  var u = n.random.getBytesSync(r.saltSize);
  var d = r.count;
  ...
  if (0 === r.algorithm.indexOf("aes") || "des" === r.algorithm) {
    ...
    switch (r.algorithm) {
      case "aes128":
        ...
        f = 16;
        g = a["aes128-CBC"];
        m = n.aes.createEncryptionCipher;
        break;
      case "aes192":
        i = 24;
        f = 16;
      ...
      case "des":
        ...
        f = 8;
        g = a.desCBC;
        m = n.des.createEncryptionCipher;
        break;
      default:
        throw (
          (((C = new Error(
    ...
    var v = h(y);
    var _ = n.pkcs5.pbkdf2(t, u, d, i, v);
    var b = n.random.getBytesSync(f);
    (E = m(_)).start(b);
    E.update(o.toDer(e));
    E.finish();
    l = E.output.getBytes();
...
s.decryptPrivateKeyInfo = function (e, t) {
  ...
  var p = n.util.createBuffer(i.encryptedData);
  d.update(p);
  if (d.finish()) {
...
s.encryptRsaPrivateKey = function (e, t, r) {
  ...
  var p = u(n.pbe.opensslDeriveBytes(t, c.substr(0, 8), l));
  p.start(c);
...
s.decryptRsaPrivateKey = function (e, t) {
  ...
  if (i.procType && "ENCRYPTED" === i.procType.type) {
    ...
    switch (i.dekInfo.algorithm) {
      case "DES-CBC":
        a = 8;
        c = n.des.createDecryptionCipher;
        break;
      case "DES-EDE3-CBC":
        a = 24;
        c = n.des.createDecryptionCipher;
      ...
      case "AES-128-CBC":
        a = 16;
        c = n.aes.createDecryptionCipher;
        break;
      case "AES-192-CBC":
        a = 24;
        c = n.aes.createDecryptionCipher;
    ...
    var d = c(n.pbe.opensslDeriveBytes(t, u.substr(0, 8), a));
    d.start(u);
    d.update(n.util.createBuffer(i.body));
...
s.pbe.generatePkcs12Key = function (e, t, r, i, o, s) {
  ...
  var h = p.length();
  var f = t.length();
  var g = new n.util.ByteBuffer();
  g.fillWithByte(r, u);
  var m = u * Math.ceil(f / u);
  var y = new n.util.ByteBuffer();
  ...
  for (w = Math.ceil(o / l), C = 1, undefined; C <= w; C++) {
    ...
    var k = new n.util.ByteBuffer();
    for (a = 0; a < x; a++) {
      var I = new n.util.ByteBuffer(b.getBytes(u));
      var A = 511;
...
s.pbe.getCipherForPBES2 = function (e, t, r) {
  ...
  var d;
  var h = a.kdfSalt;
  var f = n.util.createBuffer(a.kdfIterationCount);
  switch (((f = f.getInt(f.length() << 3)), s.oids[e])) {
    case "aes128-CBC":
      u = 16;
      d = n.aes.createDecryptionCipher;
      break;
    case "aes192-CBC":
      u = 24;
      d = n.aes.createDecryptionCipher;
    ...
    case "des-EDE3-CBC":
      u = 24;
      d = n.des.createDecryptionCipher;
      break;
    case "desCBC":
      u = 8;
      d = n.des.createDecryptionCipher;
  ...
  var g = p(a.prfOid);
  var m = n.pkcs5.pbkdf2(r, h, f, u, g);
  var y = a.encIv;
  var v = d(m);
  v.start(y);
  return v;
...
s.pbe.getCipherForPKCS12PBE = function (e, t, r) {
  ...
  var l;
  var d;
  var h = n.util.createBuffer(i.salt);
  var f = n.util.createBuffer(i.iterations);
  switch (((f = f.getInt(f.length() << 3)), e)) {
    case s.oids["pbeWithSHAAnd3-KeyTripleDES-CBC"]:
      c = 24;
      l = 8;
      d = n.des.startDecrypting;
      break;
    case s.oids["pbewithSHAAnd40BitRC2-CBC"]:
      c = 5;
      l = 8;
