...
const o = require(20839);
const s = require(96184);
const a = require(27135);
const c = require(13881);
var l;
var u;
var d;
var p;
...
exports.createMessageConnection = function (e, r, y, v) {
  ...
  function X() {
    if (N || 0 === L.size) {
      N = n.default().timer.setImmediate(() => {
        N = undefined;
        (function () {
          if (0 === L.size) return;
          const e = L.shift();
                  ...
                  try {
                    ...
                    if (c) {
                      if (undefined === e.params) {
                        ...
                        if (
                          undefined !== a &&
                          a.parameterStructures === o.ParameterStructures.byName
                        )
                          return void n(
                            new o.ResponseError(
                              o.ErrorCodes.InvalidParams,
                    ...
                    delete M[s];
                    if (r instanceof o.ResponseError) {
                      t(r, e.method, l);
                    } else {
                      if (r && i.string(r.message)) {
                        n(
                          new o.ResponseError(
                            o.ErrorCodes.InternalError,
                        ...
                        if (r) {
                          ...
                          try {
                            if (e.error) {
                              const t = e.error;
                              r.reject(
                                new o.ResponseError(t.code, t.message, t.data)
                              );
                            } else {
                              if (void 0 === e.result)
  ...
  const ce = {
    sendNotification: (e, ...t) => {
      ...
      if (i.string(e)) {
        ...
        o.ParameterStructures.is(r) && ((i = 1), (a = r));
        let c = t.length;
        const l = c - i;
        switch (l) {
          case 0:
    ...
    sendRequest: (e, ...t) => {
      ...
      if (i.string(e)) {
        ...
        const r = t[0],
          i = t[t.length - 1];
        let l = 0,
          u = o.ParameterStructures.auto;
        o.ParameterStructures.is(r) && ((l = 1), (u = r));
        let d = t.length;
        ...
        switch (p) {
          ...
          case 1:
            ...
            break;
          default:
            if (u === o.ParameterStructures.byName)
              throw new Error(
        ...
        a = c.CancellationToken.is(r[i]) ? r[i] : void 0;
      }
      const l = E++;
      let u;
      if (a) {
