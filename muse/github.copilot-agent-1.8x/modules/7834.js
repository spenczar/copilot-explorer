    ...
    e.Server.prototype.connect = function () {
      ...
      this.s.pool.write = function () {
        ...
        if ("function" == typeof arguments[e]) {
          arguments[e] = n.channel.bindToContext(arguments[e]);
        }
      ...
      this.s.pool.logout = function () {
        if ("function" == typeof arguments[1]) {
          arguments[1] = n.channel.bindToContext(arguments[1]);
        }
...
exports.enable = function () {
  n.channel.registerMonkeyPatch("mongodb-core", exports.mongoCore);
};