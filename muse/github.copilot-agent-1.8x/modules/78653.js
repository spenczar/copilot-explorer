...
var i = function (e, t, r, i) {
  ...
  o.putBytes(n.util.xorBytes(f.getBytes(), m.getBytes(), i));
  return o;
};
var o = function (e, t, r) {
  ...
  try {
    ...
    t.fragment = n.util.createBuffer(o);
    t.length = o.length;
    i = true;
  } catch (e) {}
  return i;
...
l.parseHelloMessage = function (e, t, r) {
  ...
  if (r < 38)
    ...
    if (o) e.session.cipherSuite = l.getCipherSuite(i.cipher_suite);
      ...
      for (
        var f = n.util.createBuffer(i.cipher_suites.bytes());
        f.length() > 0 &&
...
l.handleCertificate = function (e, t, r) {
  ...
  try {
    for (; c.certificate_list.length() > 0; ) {
      ...
      o = n.asn1.fromDer(i);
      i = n.pki.certificateFromAsn1(o, true);
      u.push(i);
    }
  } catch (t) {
    return e.error(e, {
...
l.handleServerHelloDone = function (e, t, r) {
  ...
  if (null === e.serverCertificate) {
    ...
    if (true !== o) {
      if (o || 0 === o) {
        if ("object" != typeof o || n.util.isArray(o)) {
          if ("number" == typeof o) {
...
l.handleFinished = function (e, t, r) {
  ...
  (o = n.util.createBuffer()).putBuffer(e.session.md5.digest());
...
l.createRandom = function () {
  ...
  r.putInt32(t);
  r.putBytes(n.random.getBytes(28));
  return r;
};
...
l.createClientHello = function (e) {
  ...
  for (
    t = n.util.createBuffer(), r = 0, undefined;
  ...
  if (e.virtualHost) {
    ...
    p.putByte(0);
    c(p, 2, n.util.createBuffer(e.virtualHost));
  ...
  if (null !== i)
    try {
      ...
      for (s = null, a = 0, undefined; a < i.length; ++a) {
        ...
        var p = n.util.createBuffer(u.body);
        if (null === s) {
          s = n.asn1.fromDer(p.bytes(), false);
        }
        var h = n.util.createBuffer();
        c(h, 3, p);
        o.putBuffer(h);
...
l.createCertificateRequest = function (e) {
  ...
  for (var i in e.caStore.certs) {
    ...
    var s = n.pki.distinguishedNameToAsn1(o.subject);
    var a = n.asn1.toDer(s);
    r.putInt16(a.length());
    r.putBuffer(a);
  }
...
l.createHeartbeat = function (e, t, r) {
  ...
  i.putBytes(n.random.getBytes(s));
  return i;
};
    ...
    if (t.fragment.length() <= l.MaxFragment) i = [t];
      ...
      for (var o = t.fragment.bytes(); o.length > l.MaxFragment; ) {
        i.push(
          l.createRecord(e, {
            type: t.type,
            data: n.util.createBuffer(o.slice(0, l.MaxFragment)),
          })
        );
...
(l.createConnection = function (e) {
  ...
  a.prepareHeartbeatRequest = function (e, t) {
    if (e instanceof n.util.ByteBuffer) {
      e = e.bytes();
    }
    if (undefined === t) {
      t = e.length;
