...
var i = n.asn1;
var o = n.pki;
var s = (module.exports = n.pkcs12 = n.pkcs12 || {});
var a = {
  name: "ContentInfo",
...
function h(e) {
  if (e.composed || e.constructed) {
    for (t = n.util.createBuffer(), r = 0, undefined; r < e.value.length; ++r) {
      var t;
      var r;
...
function f(e, t) {
  ...
  var d = n.util.createBuffer(u.value);
  l.update(d);
...
s.pkcs12FromAsn1 = function (e, t, r) {
  ...
  if (l.mac) {
    ...
    switch (_) {
      case o.oids.sha1:
        (y = n.md.sha1.create()), (v = 20);
        break;
      case o.oids.sha256:
        (y = n.md.sha256.create()), (v = 32);
        break;
      case o.oids.sha384:
        (y = n.md.sha384.create()), (v = 48);
        break;
      case o.oids.sha512:
        (y = n.md.sha512.create()), (v = 64);
        break;
      case o.oids.md5:
        (y = n.md.md5.create()), (v = 16);
    }
    if (null === y)
    ...
    var b = new n.util.ByteBuffer(l.macSalt),
      w =
        "macIterations" in l
          ? parseInt(n.util.bytesToHex(l.macIterations), 16)
          : 1,
...
s.toPkcs12Asn1 = function (e, t, r, a) {
  ...
  var c;
  var l = a.localKeyId;
  if (null !== l) l = n.util.hexToBytes(l);
    ...
    if (t) {
      ...
      (k = n.md.sha1.create()).update(
        i.toDer(o.certificateToAsn1(u)).getBytes()
      );
      l = k.digest().getBytes();
    } else l = n.random.getBytes(20);
  var d = [];
  if (null !== l) {
    d.push(
  ...
  if (a.useMac) {
    var k = n.md.sha1.create();
    var I = new n.util.ByteBuffer(n.random.getBytes(a.saltSize));
    var A = a.count;
    var P = ((e = s.generateKey(r, I, 3, A, 20)), n.hmac.create());
    P.start(k, e);
