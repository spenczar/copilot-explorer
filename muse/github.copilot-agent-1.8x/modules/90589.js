...
var d = (function () {
  ...
  e.prototype.send = function (t, r) {
    ...
    s.gzip(t, function (s, a) {
      ...
      c.info(e.TAG, o);
      o[l.disableCollectionRequestOption] = true;
      var p = u.makeRequest(n._config, i, o, function (i) {
        i.setEncoding("utf-8");
        var o = "";
      ...
      p.on("error", function (i) {
        ...
        if (
          ...
          n._enableDiskRetryMode &&
            ...
            c.warn(e.TAG, o, i);
        } else (o = "Transient failure to reach ingestion endpoint. This batch of telemetry items will be retried. Error:"), c.info(e.TAG, o, i);
        n._onErrorHelper(i);
        if ("function" == typeof r) {
  ...
  e.prototype._confirmDirExists = function (e, t) {
    var r = this;
    n.lstat(e, function (i, o) {
      if (i && "ENOENT" === i.code) {
        n.mkdir(e, function (n) {
          if (n && "EEXIST" !== n.code) {
            t(n);
          } else {
    ...
    n.readdir(e, function (r, i) {
      ...
      if (0 !== i.length)
        for (var l = 0; l < i.length; l++)
          n.stat(o.join(e, i[l]), function (e, r) {
            c++;
            if (e) {
              s = e;
            } else {
  ...
  e.prototype._getShallowDirectorySizeSync = function (e) {
    for (t = n.readdirSync(e), r = 0, i = 0, undefined; i < t.length; i++) {
      var t;
      var r;
      var i;
      r += n.statSync(o.join(e, t[i])).size;
    }
    return r;
  };
